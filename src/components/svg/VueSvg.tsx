...
const VueSvg = ({ className, color = '#ffffff' }: ISvg) => {
  return (
    <svg className={className} viewBox="0 -17.5 256 256" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" fill={color}>
