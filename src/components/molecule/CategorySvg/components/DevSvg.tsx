...
export default function DevSvg({ width = 90, height = 90, color = '#ffffff' }: ISvg) {
  return (
    <svg fill={color} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width={width} height={height}>
