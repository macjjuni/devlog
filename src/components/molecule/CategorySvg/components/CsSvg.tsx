...
const CsSvg = ({ width = 85, height = 85, color = '#ffffff' }: ISvg) => {
  return (
    <svg width={`${width}px`} height={`${height}px`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="SVGRepo_bgCarrier" strokeWidth="0" />
      <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round" />
      <g id="SVGRepo_iconCarrier">
        <path d="M12.4286 10L11 12H13L11.5714 14" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <path
        ...
        <path d="M4 9H2" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
        <path d="M22 9H20" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
        <path d="M4 15H2" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
        <path d="M22 15H20" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
        ...
        <path d="M9 20L9 22" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
        <path d="M9 2L9 4" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
        <path d="M15 20L15 22" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
        <path d="M15 2L15 4" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
        <path
